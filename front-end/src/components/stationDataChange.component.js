...
export default class StationsManage extends Component {
  ...
  handleStation(e) {
    ...
    if (this.checkBtn.context._errors.length === 0) {
      AuthService.setStation(this.state.station_id, this.state.location, this.state.company_name, this.state.phone_number, this.state.st_moderator_id, this.state.provider_id, this.state.point_id).then(
        response => {
          this.setState({
